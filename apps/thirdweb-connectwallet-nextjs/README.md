# Bera-Thirdweb Example

This repo should serve as a code example of the guide mentioned in docs.

## Sum-up on the guide.

By the end of this guide, we will explore setting up thirdweb sdk's wallet connect kit and customize it to Berachain Bepolia Testnet.
