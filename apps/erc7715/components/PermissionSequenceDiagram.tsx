  ...
  return (
    <figure className="w-full rounded-lg border border-[#2A2A2A] bg-[#0A0A0A] p-3 text-zinc-300">
      ...
      >
        ...
        <line className="stroke-[#2A2A2A]" x1="40" x2="40" y1="28" y2="280" strokeWidth="1" />

        <text className="fill-zinc-100 text-[11px] font-semibold" x="100" y="22">
          window.ethereum
        </text>
        <line className="stroke-[#2A2A2A]" x1="150" x2="150" y1="28" y2="280" strokeWidth="1" />

        <text className="fill-zinc-100 text-[11px] font-semibold" x="200" y="22">
          Wallet
        </text>
        <line className="stroke-[#2A2A2A]" x1="230" x2="230" y1="28" y2="280" strokeWidth="1" />

        <text className="fill-zinc-100 text-[11px] font-semibold" x="280" y="22">
          User
        </text>
        <line className="stroke-[#2A2A2A]" x1="300" x2="300" y1="28" y2="280" strokeWidth="1" />
