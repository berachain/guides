...
describe('TP-5 dependency preflight', () => {
  ...
  it('fails on missing BEACOND_HOME before cast call', async () => {
    setCastRunner(() => {
      throw new Error('cast should not run');
    });
  ...
  it('fails when beacond cannot read validator keys before cast call', async () => {
    setCastRunner(() => {
      throw new Error('cast should not run');
    });
