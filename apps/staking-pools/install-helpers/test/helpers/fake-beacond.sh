...
if echo "$*" | grep -q create-validator; then
  ...
  echo "credentials: $wc"
  echo "signature: 0x111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111"
