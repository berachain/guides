...
> Note: there is a max number of trades per pair (5 on Bepolia), so this bot will not run indefinitely without modifications to close open positions.

## Requirements

- NMV or Node `v20.11.0` or greater
- Wallet with testnet $HONEY tokens - See the [Berachain Bepolia Faucet](https://bepolia.faucet.berachain.com), receive $BERA and trade for $HONEY on [BEX](https://bepolia.bex.berachain.com/swap)
