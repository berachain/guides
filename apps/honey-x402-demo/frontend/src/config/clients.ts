...
const gasSubsidizerKey = import.meta.env.PRIVATE_KEY_GAS_SUBSIDIZER as
  | `0x${string}`
  | undefined;

// Fallback to Anvil defaults if not set
const ANVIL_TOKEN_HOLDER_KEY =
  "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d" as const;
const ANVIL_GAS_SUBSIDIZER_KEY =
...
export const gasSubsidizerAccount = privateKeyToAccount(
  resolvedGasSubsidizerKey,
);
