...
export function EIP3009Demo({
  ...
  const handleSign = async () => {
    setError(null);
    setStep("signing");
    setStatus("Wallet A signing authorization off-chain...");
    try {
      ...
      const fullSig = await tokenHolderClient.signTypedData({
        ...
        message: {
          from: tokenHolderAccount.address,
          to: gasSubsidizerAccount.address,
          value,
          validAfter,
          validBefore,
          nonce,
  ...
  const handleExecute = async () => {
    ...
    try {
      const hash = await gasSubsidizerClient.writeContract({
        address: demoAddress,
        abi: demoAbi,
        functionName: "transferFromWithAuthorization",
        args: [
    ...
    <div className="demo-section">
      ...
      <div className="demo-content">
        <div className="explanation">
          <p>
            <strong>How it works:</strong> The token holder signs a transfer
            authorization off-chain (no gas). Anyone can then submit this
            authorization on-chain to execute the transfer. Unlike EIP-2612,
            this does the <em>transfer directly</em> — no separate approval step
            needed.
          </p>
          <p className="highlight">
            Key: Uses random 32-byte nonces, enabling multiple parallel
            authorizations.
          </p>
        </div>
          ...
          <>
            <div className="detail-card preview">
              ...
              <div className="detail-grid">
                ...
                <span className="detail-val">
                  Random bytes32 (enables parallel authorizations)
                </span>
            ...
            <button onClick={handleSign}>
              1. Wallet A: Sign Authorization (Off-chain, No Gas)
            </button>
          </>
        )}
          ...
          <>
            <div className="detail-card sig">
              ...
              <div className="detail-grid" style={{ marginTop: "0.75rem" }}>
                ...
                <span className="detail-val">
                  {new Date(
                    Number(sigData.validBefore) * 1000,
                  ).toLocaleString()}
                </span>
