    ...
    try {
      ...
      const fullSig = await tokenHolderClient.signTypedData({
        domain: {
          ...
          version: "1",
          chainId: 31337,
          verifyingContract: honeyAddress,
        },
        types: {
          Permit: [
            { name: "owner", type: "address" },
    ...
    <div className="demo-section">
      ...
      <div className="demo-content">
        <div className="explanation">
          <p>
            <strong>How it works:</strong> The token holder signs a permit
            message off-chain (no gas). The gas subsidizer then calls{" "}
            <code>permit()</code> + <code>transferFrom()</code> on the Honey
            token, paying for the gas while moving the token holder's tokens to
            itself.
          </p>
          <p className="highlight">
            Key: Uses sequential nonces (current:{" "}
        ...
        {step === "idle" && (
          <>
            <div className="detail-card preview">
              ...
              <div className="detail-grid">
                ...
                <span className="detail-val">
                  {currentNonce?.toString() ?? "..."} (sequential)
                </span>
            ...
            <button onClick={handleSign}>
              1. Wallet A: Sign Permit (Off-chain, No Gas)
            </button>
          </>
        )}
          ...
          <>
            <div className="detail-card sig">
              ...
              <div className="detail-grid" style={{ marginTop: "0.75rem" }}>
                ...
                <span className="detail-val">
                  Wallet A permits Wallet B to spend {amount} HONEY
                </span>
                ...
                <span className="detail-key">Deadline</span>
                <span className="detail-val">
                  {new Date(Number(sigData.deadline) * 1000).toLocaleString()}
                </span>
            ...
            <div className="detail-card preview">
              ...
              <div className="detail-grid">
                ...
                <span className="detail-val">
                  <code>honey.permit()</code> — sets allowance on-chain
                </span>
                <span className="detail-key">Tx 2</span>
                <span className="detail-val">
                  <code>honey.transferFrom(Wallet A → Wallet B)</code>
                </span>
              </div>
            </div>
          ...
          <>
            <div className="detail-card receipt">
              ...
              <div className="detail-grid" style={{ marginTop: "0.75rem" }}>
                ...
                <span className="detail-key">Gas Used</span>
                <span className="detail-val">
                  {receipt.transfer.gasUsed.toLocaleString()} gas
                </span>
              </div>
              <div
